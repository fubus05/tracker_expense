...
const OverviewScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <SummaryCard iconName="trending-up-outline" color="#4caf50" title="Total Income" amount={totalIncomes} percentage={((totalIncomes / (totalIncomes + totalExpenses)) * 100).toFixed(2)} />
      <SummaryCard iconName="trending-down-outline" color="#f44336" title="Total Expenses" amount={totalExpenses} percentage={((totalExpenses / (totalIncomes + totalExpenses)) * 100).toFixed(2)} />
...
const SummaryCard = ({ iconName, color, title, amount, percentage }) => (
